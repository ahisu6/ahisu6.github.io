...
<button class="copy" style="order: 1;" onclick="copy('generated-public-key')">ＰＵＢＬＩＣキーをコピーする</button>
...
<button class="copy" style="order: 3;" onclick="copy('generated-private-key')">ＰＲＩＶＡＴＥキーをコピーする</button>
</div>
