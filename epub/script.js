...
App.prototype.doReset = function () {
    ...
    this.qs(".book").innerHTML = '<div class="empty-wrapper"><div class="empty"><div class="app-name">ePubViewerへようこそ！</div><div class="message"><a href="javascript:ePubViewer.doOpenBook();" class="big-button">本を開く</a></div></div></div>';
...
App.prototype.loadFonts = function() {
    this.state.rendition.getContents().forEach(c => {
        let style = c.document.createElement('style');
        style.textContent = `
/* latin-ext */
@font-face {
  ...
  font-style: normal;
  font-weight: 400;
  src: url('../../fonts/oY1Z8e7OuLXkJGbXtr5ba7ZlYqUcFlY.woff2') format('woff2');
...
@font-face {
  ...
  font-style: normal;
  font-weight: 400;
  src: url('../../fonts/oY1Z8e7OuLXkJGbXtr5ba7ZlbKUc.woff2') format('woff2');
...
App.prototype.doDictionary = function (word) {
    ...
    fetch(`https:///word/${encodeURIComponent(word)}`).then(resp => {
