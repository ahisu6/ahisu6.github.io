...
<br>
<button id="encryptButton">クリックして暗号化する</button>
</section>
...
<label for="verifyCheckbox">署名を確認する</label>
</p>
<br>
...
<br>
<button id="decryptButton">クリックして復号化する</button>
