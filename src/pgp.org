...
#+HTML_HEAD: <style type="text/css">.engt,.japt{background-color:transparent;font-weight:bolder;text-align:center}.engt,.japt,button,h2{text-align:center}pre,section{border-radius:3px}.engt,pre{color:#8ffa89}body{background:#0d0d0d;color:#fff;margin:0;padding:0}.container{width:50%;margin:auto;overflow:hidden}h2{background-color:#f3f3e3;color:#152515}.engt{font-size:1.5em}.japt{color:#89b7fa;font-size:2em}section{margin:10px 0;padding:10px}#key-generation{background:#3b3380}#encryption{background:#004080}#decryption{background:#831628}#fingerprint{background:#004d2a}label{margin-top:7px;display:inline}.optional{background:#a9a9a9}input:not(#verify-signature):not(#sign-message),textarea{width:100%;padding:5px;margin-top:3px;margin-bottom:10px;border-radius:3px;box-sizing:border-box}button{display:inline-block;padding:13px 20px;font-size:20px;color:#305869;background-color:#cbdee7;border-radius:15px}button.copy{font-size:15px;border-radius:25px}button:hover{background-color:#ffff1a}pre{background:#16171d;padding:5px;overflow:auto;font-size:14px}@media (max-width:500px){body{padding:2em;font-size:1em}}</style>
