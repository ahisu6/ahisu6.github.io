...
There is something called "Intrauterine system".

Basically, this is a coil that goes inside the uterus.

It releases a hormone called "progestogen". This hormone reduces the bleeding by a lot!

Finally, these Intrauterine Systems have a contraceptive effect. This means that when the woman uses them, she *CANNOT* become pregnant!!!!

@@html:<span class="jp">
「子宮内システム」というものがあります。
基本的には、子宮の中にコイルを入れるものです。
黄体「ホルモン」というホルモンを分泌させます。
このホルモンの働きで、出血がかなり抑えられます。
最後に、これらの子宮内システムは、避妊効果があります。つまり、女性が使用すると、妊娠することはできません！！！！</span>@@
