...
- Stop giving the patient food. So, make the patient nil-by-mouth. This is because if you give the patient food, they will keep vomiting. So, the solution is to stop feeding the patient. @@html:<span class="ja">患者に食べ物を与えるのを止める。つまり、患者を無言にするのだ。患者に食べ物を与えると、嘔吐し続けるからである。だから、解決策は患者に食べ物を与えるのをやめることだ。</span>@@
